...
'XG Top5 Rollout v17 Launch'|Out-File $report
$xg=$script:xg
if($null-eq$xg -or $xg.HasExited){throw 'XG process not alive after proven helper'}
Post 'xg-top5-v17/top-five-ready' 'success' 'Top five moves selected; Rollout submenu open'
...
if($null-eq$sub){Shot 'xg-top5-v17-submenu-missing';throw 'Rollout submenu missing'}
$sr=$sub.Current.BoundingRectangle
"ROLLOUT_SUBMENU_RECT: $($sr.X),$($sr.Y),$($sr.Width),$($sr.Height)"|Out-File $report -Append

# v15 and v16 screenshots independently proved this row is:
# (Preset) Moves 3-ply, cube decisions XG Roller.
$presetX=[int]($sr.X+150)
$presetY=[int]($sr.Y+69)
LeftClick $presetX $presetY
"PRESET_CLICK_POINT: $presetX,$presetY"|Out-File $report -Append
Post 'xg-top5-v17/preset-clicked' 'success' 'Clicked proven 3-ply/XG Roller preset row'
Start-Sleep 1
...
if($null-eq$dlg){Shot 'xg-top5-v17-prompt-missing';throw 'Expected Rollout prompt did not appear'}
...
if($null-eq$games -or $null-eq$ok -or $null-eq$cancel){Shot 'xg-top5-v17-prompt-signature-mismatch';DumpXG 'xg-top5-v17-prompt-signature-mismatch' $xg.Id;throw 'Rollout prompt signature mismatch'}
Shot 'xg-top5-v17-before-ok'
DumpXG 'xg-top5-v17-before-ok' $xg.Id
Post 'xg-top5-v17/prompt-verified' 'success' 'Verified Rollout prompt class, 1296 games, Ok and Cancel after proven preset click'
...
Post 'xg-top5-v17/rollout-launched' 'success' 'Clicked Ok; top-five rollout launched'

Start-Sleep 1
Shot 'xg-top5-v17-rollout-1s';DumpXG 'xg-top5-v17-rollout-1s' $xg.Id
Start-Sleep 4
Shot 'xg-top5-v17-rollout-5s';DumpXG 'xg-top5-v17-rollout-5s' $xg.Id
Start-Sleep 15
Shot 'xg-top5-v17-rollout-20s';DumpXG 'xg-top5-v17-rollout-20s' $xg.Id
$xg.Refresh()
...
Post 'xg-top5-v17/progress-captured' 'success' 'Captured rollout state through 20 seconds'
Get-Content $report
